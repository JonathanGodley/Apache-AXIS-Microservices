...
public class LoginServiceLocator extends org.apache.axis.client.Service implements localhost.identity.IdentityService.Login_jws.LoginService {
    ...
    private java.lang.String Login_address = "http://localhost:8080/identity/IdentityService/Login.jws";
    ...
    public localhost.identity.IdentityService.Login_jws.Login getLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            localhost.identity.IdentityService.Login_jws.LoginSoapBindingStub _stub = new localhost.identity.IdentityService.Login_jws.LoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (localhost.identity.IdentityService.Login_jws.Login.class.isAssignableFrom(serviceEndpointInterface)) {
                localhost.identity.IdentityService.Login_jws.LoginSoapBindingStub _stub = new localhost.identity.IdentityService.Login_jws.LoginSoapBindingStub(new java.net.URL(Login_address), this);
                _stub.setPortName(getLoginWSDDServiceName());
                return _stub;
            }
        }
