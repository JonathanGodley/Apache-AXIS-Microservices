...
public class AdminSoapBindingStub extends org.apache.axis.client.Stub implements Admin {
    ...
    private static void _initOperationDesc1(){
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "sessionKey"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        ...
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "sessionKey"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "currencyCode"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"), String.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://localhost:8080/currency/CurrencyService/Admin.jws", "ArrayOf_xsd_string"));
        oper.setReturnClass(String[].class);
 ...
 try {        Object _resp = _call.invoke(new Object[] {sessionKey});
  ...
  throw axisFaultException;
    ...
    public String[] conversionsFor(String sessionKey, String currencyCode) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {sessionKey, currencyCode});
 ...
 try {        Object _resp = _call.invoke(new Object[] {sessionKey, currencyCode});
  ...
  throw axisFaultException;
    ...
    public boolean addRate(String sessionKey, String fromCurrencyCode, String toCurrencyCode, double conversionRate) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {sessionKey, fromCurrencyCode, toCurrencyCode, new Double(conversionRate)});
  ...
  throw axisFaultException;
    ...
    public boolean updateRate(String sessionKey, String fromCurrencyCode, String toCurrencyCode, double rate) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {sessionKey, fromCurrencyCode, toCurrencyCode, new Double(rate)});
  ...
  throw axisFaultException;
    ...
    public boolean removeRate(String sessionKey, String fromCurrencyCode, String toCurrencyCode) throws java.rmi.RemoteException {
        ...
        setRequestHeaders(_call);
        setAttachments(_call);
 try {        Object _resp = _call.invoke(new Object[] {sessionKey, fromCurrencyCode, toCurrencyCode});
