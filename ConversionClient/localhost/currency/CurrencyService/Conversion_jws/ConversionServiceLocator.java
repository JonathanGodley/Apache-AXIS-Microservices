...
public class ConversionServiceLocator extends org.apache.axis.client.Service implements ConversionService {
    ...
    public ConversionServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for Conversion
    private String Conversion_address = "http://localhost:8080/currency/CurrencyService/Conversion.jws";
    ...
    private String ConversionWSDDServiceName = "Conversion";

    public String getConversionWSDDServiceName() {
        return ConversionWSDDServiceName;
    }

    public void setConversionWSDDServiceName(String name) {
    ...
    public void setConversionEndpointAddress(String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Conversion.class.isAssignableFrom(serviceEndpointInterface)) {
